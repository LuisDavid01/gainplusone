    ...
    <Card className="bg-white shadow-sm mb-6">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-xl font-bold text-gray-900 font-serif">{exercise.name}</CardTitle>
            <div className="flex items-center space-x-2 mt-2">
              <Badge variant="secondary">{exercise.difficulty}</Badge>
              <span className="text-sm text-gray-600">{exercise.muscleGroups.join(", ")}</span>
            </div>
          </div>
          <div className="text-right">
            ...
            <div className="text-sm text-gray-600">Series completadas</div>
          </div>
        </div>
      </CardHeader>
          ...
          {sets.map((set, index) => (
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-900">Serie {index + 1}</span>
              </div>
